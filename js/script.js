...
function app() {
    const buttons = document.querySelectorAll('.btn'),
        cards = document.querySelectorAll('.gallery__image')
...
(function () {
    ...
    function trackScroll() {
        ...
        if (scrolled > coords) {
            goTopBtn.classList.add('drop-inner-show');
        }
        if (scrolled < coords) {
            goTopBtn.classList.remove('drop-inner-show');
        }
    }
    ...
    let goTopBtn = document.querySelector('.drop-inner');
